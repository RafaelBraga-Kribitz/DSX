...
class TestPhase11_1Code(unittest.TestCase):
    ...
    def test_entrypoint_scan_scope_boundary_is_documented(self):
        # The full text lives in docs/known-limits.md ("moved here from the README,
        # verbatim"); README.md keeps the heading and a summary. Read both.
        readme = (self.ROOT / "README.md").read_text(encoding="utf-8") + "\n" + (
            self.ROOT / "docs" / "known-limits.md"
