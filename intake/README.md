...
directly under `intake/`, a nested folder or non-markdown file in a flat-file
kind folder (`agents/`, `prompts/`), and a skill folder missing its `SKILL.md`
are all reported too.
