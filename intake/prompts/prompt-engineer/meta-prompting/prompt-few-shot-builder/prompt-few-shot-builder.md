...
Use case 04 
Use it when you want a clear next step into adjacent prompts in Meta-Prompting or the wider Prompt Engineer library. 

## What the AI should return 

The AI should return a structured result that is directly usable in a meta-prompting workflow, with explicit outputs, readable formatting, and enough clarity to support the next step in prompt engineer work. 
