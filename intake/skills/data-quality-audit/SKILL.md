---
name: data-analytics-skills--data-quality-audit
description: Comprehensive data quality assessment against defined business rules and constraints. Use when validating data against expected schemas, checking referential integrity across tables, or auditing data pipeline outputs before production use.
---
...
**Scenario: User requests data quality audit without providing context**
→ Response: "I can help with data quality audit! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
