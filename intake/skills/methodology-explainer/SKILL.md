---
name: data-analytics-skills--methodology-explainer
...
**Scenario: User requests methodology explainer without providing context**
→ Response: "I can help with methodology explainer! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
