---
name: data-analytics-skills--analysis-retrospective
...
1. **Completed analysis**: Key information needed for this analysis
2. **Retrospective template**: Key information needed for this analysis
3. **Learning repository**: Key information needed for this analysis
4. **Action follow-up**: Key information needed for this analysis
...
**Scenario: User requests analysis retrospective without providing context**
→ Response: "I can help with analysis retrospective! To provide the most relevant analysis, I need [key context items]. Can you share [specific ask]?"
