...
description: >
  ...
  or when MADS agents want to measure improvement after a recursive-improve cycle.
when_to_use: benchmark, run benchmark, benchmark metrics, check metric quality, measure improvement, compare before after, metric quality
...
- **After a MADS project phase** — to measure agent improvement
...
- **denominator_quality** — average denominator sanity score
- **spread_quality** — failures spread across traces, not concentrated in 1-2
- **skill_coverage_rate** — fraction of skills with a metric
